...
<!-- Category Menu Fixed  -->
<div class="categoryMenu categoryMenuClose">
        <button class="categoryMenuBtn" style="position: relative;top: 0;left: 0;">
            <img class="angleButton left yellow" style="position: relative;top: 0;left: 0;"
                 src="<? bloginfo('template_url'); ?>/img/icon/w-angle-double-yellow.svg" alt="">
            <img class="angleButton left white-left" style="position: absolute;top: 0.8em;left: 0.76em;right: 0"
                 src="<? bloginfo('template_url'); ?>/img/icon/w-angle-double.svg" alt="">
        </button>
    <div style="position: relative;top: 0;left: 0;">
        <img class="img-fluid title title-yellow" style="position: relative;top: 0;left: 0;"
             src="<? bloginfo('template_url'); ?>/img/menuTitle-yellow.png" alt="">
        <img class="img-fluid title title-white" style="position: absolute;top: 0;left: 0;"
    ...
    <ul>
        <?php
        $categories = get_subcategories(get_term_by('slug', '3d_duvar_posterleri', 'product_cat')->term_id, 'product_cat', 'menu_order', 'ASC');
